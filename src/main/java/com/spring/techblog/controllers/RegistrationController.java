...
import com.spring.techblog.models.User;
...
public class RegistrationController {
    ...
    public RegistrationController(UserRepository userRepository, PasswordEncoder passwordEncoder, JwtUtils jwtUtils) {
    ...
    public ResponseEntity<?> register(@RequestBody RegistrationRequest registrationRequest) {
        ...
        User user = new User(registrationRequest.getUsername(), passwordEncoder.encode(registrationRequest.getPassword()), true);
        userRepository.save(user);

        LoginRequest loginRequest = new LoginRequest(user.getUsername(), user.getPassword());
        LoginController loginController = new LoginController();
        return loginController.authenticateUser(loginRequest);
